...
class KMeansSummarizer:
    ...
    def summarize(self, n_sentences=5, algo='advanced'):
        """
        Summarizes texts by clusters. If the parameter  'algo' == 'simple', then the method will return
        n = 'n_sentences' of texts evenly distant from the centers of the clusters. If 'algo' == 'advanced',
